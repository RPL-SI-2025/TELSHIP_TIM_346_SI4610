@php
    ...
    // Default ke 'pengguna' jika tidak ada segmen
    if (empty($activePage)) {
        $activePage = 'pengguna';
    }
@endphp
    ...
    <ul class="nav flex-column" style="list-style: none; padding-left: 0;">
        <li class="nav-item mb-2">
            @if ($activePage == 'pengguna')
                <a href="/pengguna" class="nav-link text-decoration-none"
                    ...
                    <span style="color: #6c757d; font-weight: 600;">
                        <img src="{{ asset('assets/icons/profile-icon.svg') }}" alt="Pengguna" width="18"
            ...
            @else
                <a href="/pengguna" class="nav-link text-decoration-none"
                    ...
                    <span style="color: #a0a0a0; font-weight: 400;">
                        <img src="{{ asset('assets/icons/profile-icon-no.svg') }}" alt="Pengguna" width="18"
                            style="margin-right: 8px;">
                        PENGGUNA
                    </span>
                </a>
        ...
        <li class="nav-item mb-2">
            @if ($activePage == 'monitoring')
                <a href="monitoring/mahasiswa" class="nav-link text-decoration-none"
                    style="display: block; padding: 10px 12px; border-radius: 6px; background-color: #ffffff; border: 1px solid #dee2e6;">
                    <span style="color: #6c757d; font-weight: 600;">
                        <img src="{{ asset('assets/icons/status-icon.svg') }}" alt="Monitoring" width="18"
                            style="margin-right: 8px;">
                        MONITORING
                    </span>
                </a>
            @else
                <a href="monitoring/mahasiswa" class="nav-link text-decoration-none"
                    style="display: block; padding: 10px 12px; border-radius: 6px; background-color: #f0f0f0; border: none;">
                    <span style="color: #a0a0a0; font-weight: 400;">
                        <img src="{{ asset('assets/icons/status-icon-no.svg') }}" alt="Monitoring" width="18"
                            style="margin-right: 8px;">
                        MONITORING
                    </span>
                </a>
