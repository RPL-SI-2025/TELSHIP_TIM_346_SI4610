        ...
        <div class="flex-grow-1 p-4" style="margin-top: 60px;">
            ...
            @foreach ($lowongans as $lowongan)
                <div class="card shadow-sm mb-3" style="border-radius: 12px; overflow: hidden;">
                    <div class="d-flex justify-content-between align-items-center p-3 flex-wrap flex-md-nowrap">

                        {{-- Bagian Kiri: Logo + Informasi + Tombol --}}
                        <div class="d-flex align-items-start gap-3 flex-column flex-md-row">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div style="width: 200px;">
                                    <div class="fw-bold fs-5 text-truncate" style="max-width: 100%;">
                            ...
                            <div class="d-flex mt-2 mt-md-0">
                                ...
                                <a href="{{ route('seleksi', ['id_lowongan' => $lowongan->id_lowongan]) }}"
                                ...
                                <a href="{{ route('mentor.lowongan.detail', ['id' => $lowongan->id_lowongan]) }}"
                                    style="margin-left: 1rem; background-color: #DBDBDB33; padding: 5px 10px; border-radius: 5px; text-decoration: none; font-size: 13px; color: #686868; border: 1px solid #686868;">
                                    Detail Lowongan
                                </a>
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-md-center gap-3 mt-3 mt-md-0">
                            @php
                                ...
                                $tanggalSelesaiMagang = clone $tanggalDibukaSampai;
                                $tanggalSelesaiMagang->addDays($durasiMagangHari);
                                ...
                                $badgeStyles = [
                                    ...
                                    'selesai' => ['bg' => '#ffdbdb', 'color' => '#b30000', 'text' => 'Selesai'],
                                ];

                                $status = $lowongan->status;

                                if ($tanggalSekarang > $tanggalSelesaiMagang && $status == 'disetujui') {
                                    $status = 'selesai';
                                }
                            @endphp
                    ...
                    <form action="{{ route('mentor.lowongan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="durasi_magang" name="durasi_magang"
                                placeholder="Dalam bentuk hari contoh '90 Hari'/ '90'  " required>
                        </div>

                        <div class="mb-3">
                            <label for="persyaratan" class="form-label">Persyaratan</label>
                            <textarea class="form-control" id="persyaratan" name="persyaratan" rows="3" placeholder="Ketik disini"
                                required></textarea>
                        </div>
